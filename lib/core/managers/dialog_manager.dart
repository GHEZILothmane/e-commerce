...
import 'package:ecommerce/core/models/dialog_models.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                          ...
                          obscureText: true,
                          onSaved: (value) =>
                              dialogResponse.newPassword = value,
                          validator: (value) {
                            if (value.length <= 8)
                              return "Please provide a valid password (minimum 8 caracters)";
                            return null;
              ...
              actions: <Widget>[
                FlatButton(
                  ...
                  onPressed: () {
                    _dialogService.passwordDialogComplete(
                        DialogResponsePassword(confirmed: false));
                ...
                FlatButton(
                  ...
                  onPressed: () {
                    ...
                    _dialogService.passwordDialogComplete(dialogResponse);
                    Navigator.pop(context);
                  },
                ),
              ],
                          ...
                          children: [
                            InternationalPhoneNumberInput(
                              onInputChanged: (mn) {
                                ...
                                if (!phoneVerified) phoneVerified = false;
                              },
                  ...
                  children: [
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (!validatedCode) return "Wrong validation code";
              ...
              actions: <Widget>[
                if (isConfirmationDialog)
                  FlatButton(
                    ...
                    onPressed: () {
                      _dialogService.phoneDialogComplete(
