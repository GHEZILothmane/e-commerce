...
class DialogService {
  ...
  void registerPhoneDialogListener(
      Function(DialogPhoneRequest) showDialogListener) {
    _showPhoneDialogListener = showDialogListener;
  }

  void registerFieldDialogListener(
      Function(DialogRequestFields) showDialogListener) {
    _showDialogFieldsListener = showDialogListener;
  }

  void registerPasswordDialogListener(
  ...
  Future<DialogResponse> showFieldsDialog(
      ...
      String cancelTitle = 'Cancel'}) {
    _dialogCompleter = Completer<DialogResponse>();
    _showDialogFieldsListener(DialogRequestFields(
      title: title,
      buttonTitle: confirmationTitle,
      cancelTitle: cancelTitle,
      field1Title: field1,
