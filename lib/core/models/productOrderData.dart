...
class ProductOrderData {
  ...
  factory ProductOrderData.fromMap(Map<String, dynamic> map) {
    ...
    return ProductOrderData(
      ...
      chosenVariations: List<VariationOptions>.from(
          map['chosenVariations']?.map((x) => VariationOptions.fromMap(x))),
      price: map['price'],
  ...
  factory ProductOrderData.fromJson(String source) =>
      ProductOrderData.fromMap(json.decode(source));
