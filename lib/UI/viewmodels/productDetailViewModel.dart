...
import 'package:ecommerce/core/models/Variations.dart';
...
class ProductDetailViewModel extends BaseModel {
  ...
  Future getProduct() async {
    ...
    await Task(() => _apiService.getData<ProductData>(
  ...
  void addQuantity(int i) {
    ...
    if (productOrder.quantity < 1) productOrder.quantity = 1;
    calculateTotal();
    notifyListeners();
  }

  void calculateTotal() {
    productOrder.price = (productOrder.unitPrice *
