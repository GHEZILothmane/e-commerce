...
import 'package:ecommerce/UI/viewmodels/orderViewModel.dart';
          ...
          body: CustomScrollView(
            slivers: [
              SliverAppBar(
                ...
                title: Text("${orderState.name} orders"),
                centerTitle: true,
              ),
              SliverList(
                ...
                if (model.orders.length == 0)
                  ...
                  for (OrderData order in model.orders) ...[
                    ...
                    if (order.orderState == OrderState.canceledByUser ||
                        order.orderState == OrderState.canceledByAdmin)
                      Row(
                        children: [
                          SizedBox(
                            width: 20,
