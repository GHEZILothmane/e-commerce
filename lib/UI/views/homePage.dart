import 'package:ecommerce/UI/components/mainPage/homeComponent.dart';
import 'package:ecommerce/UI/components/mainPage/notificationComponent.dart';
import 'package:ecommerce/UI/components/mainPage/profile.dart';
import 'package:ecommerce/UI/shared/colors.dart';
import 'package:ecommerce/UI/viewmodels/mainPageViewModel.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final labelTextStyle = Theme.of(context)
        .textTheme
        .subtitle2
        .copyWith(fontSize: 13.0, fontFamily: 'Product Sans');
