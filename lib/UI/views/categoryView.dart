import 'package:ecommerce/UI/components/SearchAppBar.dart';
import 'package:ecommerce/UI/components/productCard.dart';
import 'package:ecommerce/UI/components/subCategoryCard.dart';
...
class CategoryView extends StatelessWidget {
  ...
  const CategoryView({Key key, this.categoryData, this.forRedeeming = false})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    List<ProductData> newProducts =
        categoryData.products.where((element) => element.newProduct).toList();
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: ListView.separated(
                scrollDirection: Axis.horizontal,
                itemCount: categoryData.topSales.length > 10
                    ? 10
                    : categoryData.topSales.length,
