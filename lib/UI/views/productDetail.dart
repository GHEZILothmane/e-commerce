import 'package:ecommerce/UI/components/review.dart';
import 'package:ecommerce/UI/shared/colors.dart';
import 'package:ecommerce/UI/viewmodels/productDetailViewModel.dart';
import 'package:ecommerce/UI/views/base_view.dart';
import 'package:ecommerce/core/managers/Routes.dart';
import 'package:ecommerce/core/models/VariationsOptions.dart';
import 'package:ecommerce/core/models/productData.dart';
import 'package:ecommerce/core/models/reviewData.dart';
import 'package:ecommerce/core/models/uomData.dart';
...
class _ProductDetailState extends State<ProductDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView<ProductDetailViewModel>(
      ...
      onModelReady: (model) =>
          model.init(widget.productData.id, widget.isRedeeming),
                                  ...
                                  ClipRect(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child:
                                              DropdownButton<VariationOptions>(
                                            value: model.productOrder
                                                .chosenVariations[i],
                                            isExpanded: true,
                                            items: [
                                              for (VariationOptions v
                                                  in r.variations[i].options)
                                                DropdownMenuItem(
                                                  child: Text(
                                                    "${v.content}",
                                                    overflow:
