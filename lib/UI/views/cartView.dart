import 'package:ecommerce/UI/components/customTextField.dart';
import 'package:ecommerce/UI/components/productCartComponent.dart';
import 'package:ecommerce/UI/shared/colors.dart';
import 'package:ecommerce/UI/viewmodels/base_model.dart';
import 'package:ecommerce/UI/viewmodels/cartViewModel.dart';
import 'package:ecommerce/UI/views/base_view.dart';
              ...
              SliverList(
                ...
                for (int i = 0; i < model.orderData.orderList.length; i++)
                  ProductCart(
                    ...
                    onDelete: () =>
                        model.onCartProductDelete(model.orderData.orderList[i]),
                          ...
                          ExpandablePanel(
                            ...
                            expanded: Column(
                              ...
                              children: [
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.orderData.billingAdress = value,
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.orderData.billingCity = value,
                                    validator: (value) {
                                      if (value.isEmpty)
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.orderData.billingState = value,
                                    validator: (value) {
                                      if (value.isEmpty)
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.orderData.billingZipCode = value,
                                    validator: (value) {
                                      if (value.isEmpty ||
                                ...
                                CustomTextField(
                                    ...
                                    onSaved: (value) =>
                                        model.orderData.billingCountry = value,
                                    validator: (value) {
                                      if (value.isEmpty)
                                ...
                                InternationalPhoneNumberInput(
                                  onInputChanged: (mn) {
                                    model.orderData.billingMobileNumber =
                                        mn.phoneNumber;
                                  },

                                  initialValue: PhoneNumber(
                                      phoneNumber: "", isoCode: "DZ"),
                                  formatInput: false,
                                  countries: ["DZ"],
                                  validator: (value) {
                          ...
                          ExpandablePanel(
                            ...
                            expanded: Column(
                              ...
                              children: [
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.orderData.deliveryAdress = value,
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.orderData.deliveryCity = value,
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.orderData.deliveryState = value,
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.orderData.deliveryZipCode = value,
                                ...
                                CustomTextField(
                                    ...
                                    onSaved: (value) =>
                                        model.orderData.deliveryCountry = value,
                                    validator: (value) {
                                      if (value.isEmpty)
                                        return "Please provide a country";
                                      return null;
                                ...
                                InternationalPhoneNumberInput(
                                  onInputChanged: (mn) {
                                    model.orderData.deliveryMobileNumber =
                                        mn.phoneNumber;
                                  },
                      ...
                      if (model.calculatingTotal)
                        ...
                        Align(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text("Couldn't calculate order total"),
                              Padding(
