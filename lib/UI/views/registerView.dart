...
import 'package:ecommerce/UI/viewmodels/registerViewModel.dart';
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              "Register",
              style:
                  TextStyle(fontFamily: 'Raleway', color: Colors.grey.shade800),
            ),
            centerTitle: true,
          ),
          body: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          ExpandablePanel(
                            ...
                            expanded: Column(
                              ...
                              children: [
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.user.billingAdress = value,
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.user.billingZipCode = value,
                                ...
                                CustomTextField(
                                    ...
                                    enabled: false,
                                    onSaved: (value) =>
                                        model.user.billingCountry = value,
                                    validator: (value) {
                                      if (value.isEmpty)
                          ...
                          ExpandablePanel(
                            ...
                            expanded: Column(
                              ...
                              children: [
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.user.deliveryAdress = value,
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.user.deliveryState = value,
                                ...
                                CustomTextField(
                                    onSaved: (value) =>
                                        model.user.deliveryZipCode = value,
                                ...
                                CustomTextField(
                                    ...
                                    enabled: false,
                                    onSaved: (value) =>
                                        model.user.deliveryCountry = value,
                                    validator: (value) {
                                      if (value.isEmpty)
                                        return "Please provide a country";
                                      return null;
                          ...
                          InternationalPhoneNumberInput(
                            ...
                            formatInput: false,
                            initialValue:
                                PhoneNumber(phoneNumber: "", isoCode: "DZ"),
                            countries: ["DZ"],
                            validator: (value) {
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () => Navigator.of(context).pushNamed(
                                    RoutesManager.termsAndConditions),
                                child: Text(
                                  "Term & Conditions",
