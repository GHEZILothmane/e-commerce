...
class ProductCart extends StatelessWidget {
  ...
  void navigateToProductDetail(BuildContext context) =>
      Navigator.pushNamed(context, RoutesManager.productDetail,
          arguments: productOrderData.product);
        ...
        children: [
          GestureDetector(
            ...
            child: Padding(
              ...
              child: Card(
                ...
                child: Image.network(
                  productOrderData
                      .product.images[productOrderData.chosenSubProduct].image,
                  width: 80,
                  height: 170,
                  fit: BoxFit.fill,
                ),
          ...
          Expanded(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: GestureDetector(
                      onTap: () => navigateToProductDetail(context),
                      child: Text(productOrderData.product.title,
                          maxLines: 2,
              ...
              if (productOrderData.product.quantity >=
                      productOrderData.quantity &&
                  editable)
                Text(
                  "(Available)",
              ...
              RichText(
                text: TextSpan(
                    ...
                    children: <TextSpan>[
                      for (VariationOptions variation
                          in productOrderData.chosenVariations)
