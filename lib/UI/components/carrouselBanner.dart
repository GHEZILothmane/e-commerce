...
import 'package:ecommerce/UI/viewmodels/carrouselBannerViewModel.dart';
import 'package:ecommerce/UI/views/base_view.dart';
import 'package:ecommerce/core/models/carrouselData.dart';
                  ...
                  PageView(
                    ...
                    children: [
                      for (CarrouselData carr in carrousel)
                        Image.network(
                          carr.image ??
                              "${ApiService.endpoint}/static/defaultBanner.jpg",
                          height: 150,
                          fit: BoxFit.fill,
                        )
                    ],
