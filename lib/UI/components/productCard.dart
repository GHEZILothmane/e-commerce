...
import 'package:ecommerce/UI/viewmodels/productCardViewModel.dart';
...
class ProductCard extends StatelessWidget {
  const ProductCard({Key key, this.productData, this.forRedeeming = false})
      : super(key: key);

  final ProductData productData;
  final bool forRedeeming;

  void navigateToProductDetail(BuildContext context) => Navigator.pushNamed(
      context,
      forRedeeming
          ? RoutesManager.productDetailRedeem
          : RoutesManager.productDetail,
                          ...
                          children: [
                            Text(
                                productData.discount != 0
                                    ? 'DZ${productData.priceWithDiscount.toStringAsFixed(2)}'
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: IconButton(
                                ...
                                onPressed: () =>
                                    model.addToWishList(productData),
                              ),
                            ),
                          ),
                        ),
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: IconButton(
                              ...
                              onPressed: () =>
                                  model.addToCart(productData, forRedeeming),
                            ),
                          ),
                        ),
                      ),
